...
} from '../actions/public/L1/simulateDepositCustomGas.js'
//
import {
  simulateDepositETH,
...
> = {
  ...
  simulateDepositCustomGas: <
    ...
    TAccountOverride extends Account | Address | undefined = undefined,
  >(
    args: SimulateDepositCustomGasParameters<TChain, TChainOverride, TAccountOverride>,
  ) => Promise<SimulateDepositCustomGasReturnType<TChain, TAccount, TChainOverride, TAccountOverride>>
  simulateDepositTransaction: <
    TChainOverride extends Chain | undefined,
    TAccountOverride extends Account | Address | undefined = undefined,
  >(
...
>(
  ...
  return {
    ...
    simulateDepositCustomGas: (args) => simulateDepositCustomGas(client, args),
